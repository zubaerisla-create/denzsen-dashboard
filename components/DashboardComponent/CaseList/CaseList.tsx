...
import { Eye, Search, Download, ChevronLeft, ChevronRight, Loader2, Filter } from 'lucide-react';
import Link from 'next/link';
import { useGetCasesQuery } from '@/redux/services/api';
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 text-left">
              <tr>
                <th className="p-4 font-semibold text-gray-700 text-sm">Case ID</th>
                <th className="p-4 font-semibold text-gray-700 text-sm">Reporter</th>
                ...
                <th className="p-4 font-semibold text-gray-700 text-sm">Date Reported</th>
